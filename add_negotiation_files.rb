#!/usr/bin/env ruby
# Script to add negotiation-related files to the Xcode project
...
# Files to add
files_to_add = [
  { path: 'Billix/Features/BillSwap/Views/SwapNegotiationView.swift', group_path: 'Billix/Features/BillSwap/Views' },
  { path: 'Billix/Features/BillSwap/ViewModels/SwapNegotiationViewModel.swift', group_path: 'Billix/Features/BillSwap/ViewModels' },
  { path: 'Billix/Features/BillSwap/Components/TermNegotiationCard.swift', group_path: 'Billix/Features/BillSwap/Components' }
]
