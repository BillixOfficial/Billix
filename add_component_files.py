#!/usr/bin/env python3
"""
Add Upload Component files to Xcode project with correct paths
"""

import uuid

# Component files that need to be added (with full paths from project root)
component_files = [
    "Billix/Features/Upload/Views/Components/AnalysisBreakdownTab.swift",
    "Billix/Features/Upload/Views/Components/AnalysisCompareTab.swift",
    "Billix/Features/Upload/Views/Components/AnalysisComponents.swift",
    "Billix/Features/Upload/Views/Components/AnalysisDetailsTab.swift",
    "Billix/Features/Upload/Views/Components/AnalysisResultsSimpleView.swift",
    "Billix/Features/Upload/Views/Components/AnalysisResultsView.swift",
    "Billix/Features/Upload/Views/Components/BillGaugeView.swift",
    "Billix/Features/Upload/Views/Components/MetricCardView.swift",
]
...
for file_path in component_files:
    ...
    if filename in content and "Components/" + filename in content:
